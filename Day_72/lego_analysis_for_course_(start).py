...
Original file is located at
    https://colab.research.google.com/drive/1M1Ijr5WLcoayowrXRkgZTODootBSzte0
...
"""<h3> LEGO Themes vs. LEGO Sets</h3>
...
set_df.groupby('year').count()

"""**Challenge**: Find the top 5 LEGO sets with the most number of parts. """

set_df.sort_values('year', ascending=False)
